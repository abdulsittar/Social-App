...
const handleUserNameChange = async (e) => {
  ...
  const handleClick = async (e) => {
    ...
    //}else 
    if (value_q2 == ""){
      toast.error("Question 1. Bitte wählen Sie eine vorgegebene Auswahl aus!");
      return
    }else if (value_q3 == ""){
  ...
  useEffect(() => {
   ...
   return (
      ...
      <p className={classes.secon_disclaimor}>{post_info_2}</p>
        ...
        <CSSTransition in={is_Q5_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q6_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q7_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q8_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q9_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q10_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q11_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q12_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q13_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q14_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q15_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q16_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q17_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
        ...
        <CSSTransition in={is_Q18_visible} timeout={50} classNames="fade" unmountOnExit >
        <div id='sixBlock'>
